#This is a windows cleanup tool that will update windows, do dism, then run memory diagnostics. Just spam "a" whenever you get a prompt to do so.
...
function Show-Menu
{
     ...
     Write-Host "2: Press '2' to check disk and run memory diagnostics."
